...
class Predictions(models.Model):
    SYMPTOMS_CHOICES = (
        ...
        ('rise_in_temperature', 'rise_in_temperature'),
        ('fever', 'fever'),
        ...
        ('increased_respiratory_rate', 'increased_respiratory_rate'),
    ...
    def __str__(self):
        ...
        return self.symptom1, self.symptom2, self.symptom3, self.symptom4, self.symptom5
