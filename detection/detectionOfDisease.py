...
first = [ 'rise_in_temperature', 'fever','lacrimation', 'abnormal_salivation', 'nasal_discharge', 'lameness',
            ...
            'enlarged_parotid_gland', 'increased_respiratory_rate', 'reluctant_to_move', 'anaemia', 'jaundice', 'severe_diarrhoea', 'swelling_in_the_neck',
...
#loading dataset
tr = pd.read_csv("symptoms.csv") #training data
'''
...
classification_models = [log_cf, svc_cf, knn_cf, dtree_cf, randomforest_cf]
...
for i in range(0, len(X_val)):
    ...
    maxpred.append(mode([pred1[i], pred2[i], pred3[i], pred4[i], pred5[i]]))
...
user_input = {'rise_in_temperature':0, 'fever':0,'lacrimation': 1, 'abnormal_salivation': 0, 'nasal_discharge': 0, 'lameness': 1,'firm_nodules_on_the_skin': 1,
              ...
              'enlarged_parotid_gland': 1,'increased_respiratory_rate':0,'reluctant_to_move': 0, 'anaemia': 0, 'jaundice':0, 'severe_diarrhoea': 1, 'swelling_in_the_neck': 0,
