...
# def ohevalue(df):
#
#     #ohe_col= joblib.load("/Users/Linny/PycharmProjects/TestingModel/prediction/encodedcolumns.pkl")
#     cat_columns = ['lacrimation', 'abnormal_salivation', 'nasal_discharge', 'lameness',
#                    'firm_nodules_on_the_skin', 'enlarged_lymph_nodes', 'swollen_sore_legs', 'loss_of_appetite',
#                    'eyes_nose_discharge', 'drop_in_milk',
#                    'weight_loss', 'blisters_in_mouth_and_feet', 'blisters_on_teats', 'dullness', 'shivering',
#                    'rough_coat',
#                    'enlarged_parotid_gland', 'reluctant_to_move', 'anaemia', 'jaundice', 'severe_diarrhoea',
...
def approvereject(request):
    try:
        ...
        model = joblib.load("/Users/Linny/PycharmProjects/TestingModel/prediction/model.pkl")
        user_input = {'lacrimation': 0, 'abnormal_salivation': 0, 'nasal_discharge': 0, 'lameness': 0,
                      ...
                      'shivering': 0,
                      'rough_coat': 0,
                      'enlarged_parotid_gland': 0, 'reluctant_to_move': 0, 'anaemia': 0, 'jaundice': 0,
                      'severe_diarrhoea': 0,
...
def cxcontact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            myData = {symptom1, symptom2, symptom3, symptom4, symptom5, symptom6}
            ...
            def input_to_one_hot(data):
                ...
                s_list = ['lacrimation','abnormal_salivation', 'nasal_discharge', 'lameness',
                               ...
                               'shivering',
                               'rough_coat',
                               'enlarged_parotid_gland', 'reluctant_to_move', 'anaemia', 'jaundice',
                               'severe_diarrhoea',
                               'swelling_in_the_neck',
                               'cloudiness_of_the_eyes', 'breathing_difficulty', 'cyanosis_of_the_tongue',
                               'swelling_of_tongue_and_face']
